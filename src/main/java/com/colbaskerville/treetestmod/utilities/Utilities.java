package com.colbaskerville.treetestmod.utilities;
...
import com.colbaskerville.treetestmod.networking.MessageSyncEntityToServer;
...
public class Utilities
{
    ...
    public static void sendEntitySyncPacketToClient(IModEntity parEntity)
    {
        ...
        if (!theEntity.getEntityWorld().isRemote)
        {
            ...
            ModNetworking.network.sendToAll(new MessageSyncEntityToClient(theEntity.getEntityId(), parEntity.getSyncDataCompound()));
        }
    }
    ...
    public static void sendEntitySyncPacketToServer(IModEntity parEntity)
    {
        ...
        if (theEntity.getEntityWorld().isRemote)
        {
            ...
            ModNetworking.network.sendToServer(new MessageSyncEntityToServer(theEntity.getEntityId(), parEntity.getSyncDataCompound()));
        }
    }
