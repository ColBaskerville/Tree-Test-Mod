package com.colbaskerville.treetestmod.worldgen;
...
public class WorldGenTreesApple extends WorldGenAbstractTree
{
	private IBlockState blockStateWood = ModBlocks.apple_log.getDefaultState();
	private IBlockState blockStateLeaves = ModBlocks.apple_leaves.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
	private final int minTreeHeight = 4;
	
	public WorldGenTreesApple(boolean parShouldNotify)
	{
